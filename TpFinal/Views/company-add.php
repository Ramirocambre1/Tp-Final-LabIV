...
<section class="login-block">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <form class="md-float-material form-material" action="<?php echo  FRONT_ROOT."Company/Add "?>" method="POST">
                    <div class="auth-box card">
                        <div class="card-block">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="text-center heading">Add New Company</h3>
                                </div>
                            </div>
                            ...
                            <div class="form-group form-primary"> <input autocomplete="off" type="number" class="form-control" name="phoneNumber" placeholder="Phone Number" value="" id="phoneNumber" required> </div>
