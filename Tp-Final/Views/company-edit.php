                ...
                <form class="md-float-material form-material" action="<?php echo  FRONT_ROOT."Company/Edit "?>" method="POST">
                    <div class="auth-box card">
                        <div class="card-block">
                            ...
                            <div class="form-group form-primary"> <input type="number" class="form-control" name="companyId" placeholder="Company Id" value="" id="companyId" pattern="[0-9]" required> </div>
